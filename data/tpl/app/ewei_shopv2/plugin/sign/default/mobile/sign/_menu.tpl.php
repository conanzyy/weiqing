...
<?php  if(p('creditshop')) { ?>
    <a href="<?php  echo mobileUrl('creditshop')?>"
       class="external nav-item <?php  if($_W['routes'] == 'creditshop.sign') { ?>active<?php  } ?>">
        ...
        <span class="label"><?php  echo $p['credit'];?>商城</span>
    </a>
<?php  } ?>
